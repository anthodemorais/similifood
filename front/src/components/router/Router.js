...
import NewUser from "../login/signup"
...
export default class Routing extends Component {
  render() {
    ...
    <Router>
        ...
        <Route exact="exact" path={`/user/update/me/password`} component={UpdatePassword}/>
        <Route exact="exact" path={`/user/update/me/username`} component={UpdateUser}/>
        {/* Connexion */}
        <Route exact="exact" path={`/login`} component={Connexion}/>
        <Route exact="exact" path={`/signup`} component={NewUser}/>
        {/* panier */}
